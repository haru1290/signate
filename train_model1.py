...
def tmp(args):
    ...
    print(train.groupby('Country').count())
    print(test.groupby('Country').count())
...
def main(args):
    ...
    model_1e = ModelElasticNet()
    pred_train_1e, pred_test_1e = predict_cv(model_1e, X_train_valid, y_train_valid, X_test)

    model_1f = ModelRandomForest()
    pred_train_1f, pred_test_1f = predict_cv(model_1f, X_train_valid, y_train_valid, X_test)
    ...
    print(f'e ElasticNet RMSE: {mean_squared_error(y_train_valid, pred_train_1e, squared=False):.4f}')
    print(f'f RandomForest RMSE: {mean_squared_error(y_train_valid, pred_train_1f, squared=False):.4f}')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--X_train_valid', default='./data/train.csv')
    parser.add_argument('--X_test', default='./data/test.csv')
